...
Sends the file as an attachment to whatever `--to` address the caller specifies. The relay forwards to any address - internal team mailboxes, external partner domains, contractor inboxes, or anywhere else.

## When to use

- A developer wants a file mailed somewhere.
